...
def show_onerSinger(singer):
    singerSongList = os.listdir(f"{singerListDir}/{singer}")
...
def make_singerDic():
    ...
    totalList = os.listdir(f"{mp3Dir}")
    #print(f"singerDic:{singerDic},nowList:{nowList},totalList:{totalList}")
    ...
    for i in singerDic:
        ...
        if i in nowList:
            ...
            #print(f"thisSingerDir:{thisSingerDir},nowNum:{nowNum}")
